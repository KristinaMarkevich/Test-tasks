...
tb1
| id   | storeid | city | year |                              
|-----------|-------|-------|-------|
| 1      | 3  | Москва  | 1991   | 
| 2      | 4   | Ульяновск   | 1980  |
| 3    | 2   | Москва  | 1987   | Есть  | 
| 4    | 1   | Сочи  | 1996   | Есть  | 
...
```
select store as 'Название магазина' from tb2
join tb1
on tb2.id = tb1.storeid
where tb1.year > 1990 and city = 'Москва';
```

4. Представьте, что во время тестирования приложения Вы замечаете дефект,
что на устройствах Motorolla кнопка записи диктовки не активна. Опишите данный дефект в баг-репорт с указанием критичности и приоритета.

*Название* - Кнопка записи диктовки не активна на экране "Главная страница" при использовании устройств Motorolla

*Окружение* - Motorolla Falagy Pro 5G, Android 10.2
...
2. Открыт экран "Главная страница"
              
*Шагивоспроизведения* - 
1. Нажать на кнопку записи диктовки 

*Ожидаемый результат* - Кнопка записи диктовки активна

*Фактический результат* - Кнопка записи диктовки не активна

*Приложения* - Кнопка_записи_диктовки_не_активна.mp4
